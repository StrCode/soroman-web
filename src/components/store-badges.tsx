/**
 * The App Store / Google Play pills. Shared by the landing page's app section
 * and the order wizard's closing step, so the store URLs and brand glyphs
 * exist once — the links themselves live in lib/company.ts.
 */

import { APP_STORE_URL, PLAY_STORE_URL } from "@/lib/company";
